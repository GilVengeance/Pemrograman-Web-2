...
$psn1 = new BMIPasien('06-01-2022');
$psn1->kode = 'P001';
$psn1->nama = 'Tami';
$psn1->gender = 'L';

$psn2 = new BMIPasien('25-05-2022');
$psn2->kode = 'P002';
$psn2->nama = 'Audrey';
$psn2->gender = 'P';

$psn3 = new BMIPasien('13-06-2022');
$psn3->kode = 'P003';
$psn3->nama = 'Gabriel';
$psn3->gender = 'L';
...
$bmi1 = new BMI($psn1, 43, 172);
$bmi2 = new BMI($psn2, 62, 158);
$bmi3 = new BMI($psn3, 55, 171);
